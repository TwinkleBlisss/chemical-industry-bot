...
# for i in range(1, 10):
#     conn.insert_into_table("eurocube", i, "2022-12-12", i)
...
# conn.insert_into_table("order", 1, 200000, "2023-10-01")
# conn.insert_into_table("order", 2, 135000, "2023-12-17")
# conn.insert_into_table("order", 3, 500000, "2023-12-20")
#
